...
export default function Edit( { attributes, setAttributes } ) {
    ...
    const CARDBODY_TEMPLATE = [
        [ 
            'core/paragraph', 
            { 
                placeholder: __( "Add your card body content here... This inner structural component frames descriptions, texts, media layouts, or button items cleanly.", 'wm' ),
            } 
        ]
    ];
        ...
        <>
            ...
            <div { ...blockProps }>
                { hasVideo ? (
                    ...
                    <InnerBlocks template={ CARDBODY_TEMPLATE } renderAppender={ InnerBlocks.ButtonBlockAppender } />
                ) }
            </div>
        </>
    );
