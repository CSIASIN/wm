...
const BTN_VARIANTS = [
	...
	{ label: 'Light', value: 'btn-light' }, { label: 'Dark', value: 'btn-dark' },
];
...
export default function Edit({ attributes, setAttributes }) {
	...
	const blockProps = useBlockProps({ className: 'wmblocks-hero5' });
	...
	return (
		<>
			...
			<div {...blockProps}>
				<div className={wrapClass} style={{ borderTop: '1px solid #dee2e6', borderBottom: '1px solid #dee2e6' }}>
					<div className="row flex-lg-row-reverse align-items-center g-5 py-5">
						{ /* Image */ }
						<div className="col-10 col-sm-8 col-lg-6">
							{imageUrl ? (
								<div style={{ position:'relative' }}>
									<img src={imageUrl} alt={imageAlt} className="d-block mx-lg-auto img-fluid rounded shadow-lg" style={{ maxHeight:320, width:'100%', objectFit:'cover' }} />
