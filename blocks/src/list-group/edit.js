                            ...
                            >
                                { hasSub || hasBadge ? (
                                    <div className="d-flex justify-content-between align-items-start">
                                        <div className="ms-2 me-auto" onMouseDown={ ( e ) => e.stopPropagation() }>
                                            <RichText
                                                tagName="div"
                                                className="fw-bold"
                                                value={ item.text }
                                                onChange={ ( v ) => updateItem( i, 'text', v ) }
                                                placeholder={ __( 'Item text...', 'wmblocks' ) }
                                            ...
                                            { hasSub && (
                                                <RichText
                                                    ...
                                                    placeholder={ __( 'Optional subtitle...', 'wmblocks' ) }
                                                    allowedFormats={ [] } 
                                    ...
                                    <div className="d-flex justify-content-between align-items-center" onMouseDown={ ( e ) => e.stopPropagation() }>
                                        <RichText
                                            tagName="span"
                                            value={ item.text }
                                            onChange={ ( v ) => updateItem( i, 'text', v ) }
