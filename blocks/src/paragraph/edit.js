...
export default function Edit({ attributes, setAttributes }) {
	...
	const gradientPresets = [
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(212, 252, 121), rgb(150, 230, 161))",
		},
		{
			name: "Neon Green",
			class: "bg-neon-green",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(255, 117, 195), rgb(255, 166, 71), rgb(255, 232, 63), rgb(159, 255, 91), rgb(112, 226, 255), rgb(205, 147, 255))",
		},
		{
			name: "Racker",
			class: "bg-racker",
			style:
				"linear-gradient(to right, rgb(235, 0, 0), rgb(149, 0, 138), rgb(51, 0, 252))",
		},
		{
			name: "Hyper Blue",
			class: "bg-hyper-blue",
		...
		},
		{
			...
			class: "bg-whinehouse",
			style:
				"linear-gradient(to right, rgb(247, 247, 247), rgb(185, 160, 160), rgb(121, 71, 71), rgb(78, 32, 32), rgb(17, 17, 17))",
		},
		{
			name: "Moonwalker",
			class: "bg-moonwalker",
		...
		},
		{
			...
			class: "bg-ameena",
			style:
				"linear-gradient(to right, rgb(12, 12, 109), rgb(222, 81, 43), rgb(152, 208, 193), rgb(91, 178, 38), rgb(2, 60, 13))",
		},
		{
			name: "Winter Woods",
			class: "bg-winter-woods",
			style:
				"linear-gradient(to right, rgb(51, 51, 51), rgb(162, 171, 88), rgb(164, 57, 49))",
		},
		{
			name: "Abbas",
			class: "bg-abbas",
		...
		},
		{
			...
			class: "bg-peach-sea",
			style:
				"linear-gradient(to right, rgb(230, 174, 140), rgb(168, 206, 207))",
		},
		{
			name: "Elate The Euge",
			class: "bg-elate-the-euge",
			style:
				"linear-gradient(to right, rgb(139, 222, 218), rgb(67, 173, 208), rgb(153, 142, 224), rgb(225, 125, 194), rgb(239, 147, 147))",
		},
		{
			name: "Flower",
			class: "bg-flower",
			style:
				"linear-gradient(to right, rgb(220, 255, 189), rgb(204, 134, 209))",
		},
		{
		...
		},
		{
			...
			class: "bg-blooze",
			style:
				"linear-gradient(to right, rgb(109, 166, 190), rgb(75, 133, 158), rgb(109, 166, 190))",
		},
		{
			name: "Twitter",
			class: "bg-twitter",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(247, 240, 172), rgb(172, 247, 240), rgb(240, 172, 247))",
		},
		{
			name: "Mango Papaya",
		...
		},
		{
			...
			class: "bg-beleko",
			style:
				"linear-gradient(to right, rgb(255, 30, 86), rgb(249, 201, 66), rgb(30, 144, 255))",
		},
		{
			name: "Lemon Lime",
			class: "bg-lemon-lime",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(39, 116, 174), rgb(0, 46, 93), rgb(0, 46, 93))",
		},
		{
			name: "Newspaper",
			class: "bg-newspaper",
			style:
				"linear-gradient(to right, rgb(138, 43, 226), rgb(255, 165, 0), rgb(248, 248, 255))",
		},
		{
			name: "Lensod",
			class: "bg-lensod",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(5, 25, 55), rgb(0, 77, 122), rgb(0, 135, 147), rgb(0, 191, 114), rgb(168, 235, 18))",
		},
		{
			name: "Electric Peacock",
			class: "bg-electric-peacock",
			style:
				"linear-gradient(to right, rgb(138, 43, 226), rgb(0, 0, 205), rgb(34, 139, 34), rgb(204, 255, 0))",
		},
		{
			name: "Zenta",
			class: "bg-zenta",
		...
		},
		{
			...
			class: "bg-telko",
			style:
				"linear-gradient(to right, rgb(243, 98, 34), rgb(92, 182, 68), rgb(0, 127, 195))",
		},
		{
			name: "Grade Grey",
			class: "bg-grade-grey",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(251, 237, 150), rgb(171, 236, 214))",
		},
		{
			name: "Blu",
			class: "bg-blu",
		...
		},
		{
			...
			style:
				"linear-gradient(to right, rgb(247, 148, 30), rgb(114, 198, 239), rgb(0, 166, 81))",
		},
		{
			name: "Ibtesam",
			class: "bg-ibtesam",
		...
		},
		{
			...
			class: "bg-omolon",
			style:
				"linear-gradient(to right, rgb(9, 30, 58), rgb(47, 128, 237), rgb(45, 158, 224))",
		},

		{
			...
			style:
				"linear-gradient(30deg, #fe1a00, transparent 40%), linear-gradient(90deg,  #fd8f00, transparent 40%), linear-gradient(150deg, #23b550, transparent 40%), linear-gradient(210deg, #1061ff, transparent 40%), linear-gradient(270deg, #7b24a0, transparent 40%), linear-gradient(330deg, #ab31a9, transparent 40%)",
		},
		{
			name: "Multicolor Light Gradient Background Photo",
			class: "bg-multicolor-light-gradient-background-photo",
			style:
				"linear-gradient(45deg, #0000ff, transparent 50%), linear-gradient(135deg, #ff0080, transparent 50%), linear-gradient(225deg, #80ff00, transparent 50%), linear-gradient(315deg, #7b24a0, transparent 50%)",
		},
		{
			name: "Multicolor Radial Gradient Background Png",
			class: "bg-multicolor-radial-gradient-background-png",
			style:
				"radial-gradient(at 50% 10%, #fe1a00 -20%, transparent 30%), radial-gradient(at 30% 20%, #fd8f00 -20%, transparent 30%), radial-gradient(at 20% 50%, #fdcc00 -20%, transparent 30%), radial-gradient(at 30% 80%, #89e23b -20%, transparent 30%), radial-gradient(at 50% 90%, #23b550 -20%, transparent 30%), radial-gradient(at 70% 80%, #1061ff -20%, transparent 30%), radial-gradient(at 80% 50%, #ab31a9 -20%, transparent 30%), radial-gradient(at 70% 20%, #fff100 -20%, transparent 30%); background-blend-mode: screen",
		},
	];
	...
	const blockStyle = {
		...
		"--wm-dropcap-lines": dropCapSize
			? Math.max(2, Math.floor(dropCapSize * 0.75))
			: undefined,
			...
			<InspectorControls>
				<PanelBody title={__("Link Colors", "wm")} initialOpen={false}>
					<BaseControl label={__("Link Color", "wm")}>
						<ColorPicker
							color={linkColor}
							onChangeComplete={(v) => setAttributes({ linkColor: v.hex })}
							disableAlpha
						/>
					</BaseControl>
					<BaseControl label={__("Link Hover Color", "wm")}>
						<ColorPicker
							...
							onChangeComplete={(v) => setAttributes({ linkHoverColor: v.hex })}
							disableAlpha
						/>
					</BaseControl>
				</PanelBody>
				...
				<PanelBody
					title={__("Structural Tags & Toggles", "wm")}
					initialOpen={false}
				>
					<ToggleControl
						label="Drop Cap"
						checked={dropCap}
						onChange={(v) => setAttributes({ dropCap: v })}
					/>
					<ToggleControl
						label="Strong (Bold Wrap)"
						checked={wrapStrong}
						onChange={(v) => setAttributes({ wrapStrong: v })}
					/>
					<ToggleControl
						label="Italic (Em Wrap)"
						checked={wrapEm}
						onChange={(v) => setAttributes({ wrapEm: v })}
					/>
					<ToggleControl
						label="Deleted (Del Wrap)"
						checked={wrapDel}
						onChange={(v) => setAttributes({ wrapDel: v })}
					/>
					<ToggleControl
						label="Insertion (Ins Wrap)"
						checked={wrapIns}
						onChange={(v) => setAttributes({ wrapIns: v })}
					/>
					<ToggleControl
						label="Monospace Font"
						checked={fontMonospace}
						onChange={(v) => setAttributes({ fontMonospace: v })}
					/>
					<ToggleControl
						label="Text Reset"
						checked={textReset}
						onChange={(v) => setAttributes({ textReset: v })}
					/>
				</PanelBody>

				<PanelBody title={__("Background Color", "wm")}>
					<p style={{ fontSize: "12px", marginBottom: "8px" }}>
						Select a predefined Bootstrap shade. This updates both background
						and text color automatically.
					</p>
					<ColorPalette
						colors={backgroundColors}
						value={
							backgroundColors.find((c) => c.slug === backgroundColorClass)
								?.color
						}
						onChange={(value) => {
						...
						>
							...
							<button
								...
								style={{
									height: "40px",
									border:
										bgGradient === "" ? "2px solid #000" : "1px solid #ccc",
									borderRadius: "4px",
									background: "#f0f0f0",
									cursor: "pointer",
								}}
