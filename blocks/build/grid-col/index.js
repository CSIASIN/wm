...
const ALLOWED = ['wmblocks/div', 'wmblocks/icon-text', 'wmblocks/bs-heading', 'core/shortcode', 'contact-form-7/contact-form-selector', 'wmblocks/grid-row', 'wmblocks/grid-container', 'wmblocks/card-basic', 'wmblocks/container', 'wmblocks/flex-container', 'wmblocks/vstack', 'wmblocks/hstack', 'core/paragraph', 'core/heading', 'core/image', 'core/list', 'core/group', 'core/columns', 'core/html', 'wmblocks/bs-image', 'wmblocks/bs-figure', 'wmblocks/object-fit', 'wmblocks/accordion', 'wmblocks/tabs', 'wmblocks/carousel', 'wmblocks/collapse', 'wmblocks/modal', 'wmblocks/toast', 'wmblocks/progress', 'wmblocks/list-group', 'wmblocks/bs-form', 'wmblocks/icon-link', 'wmblocks/buttons', 'wmblocks/button-group', 'wmblocks/image-link', 'wmblocks/position-wrapper', 'wmblocks/card', 'wmblocks/card-image', 'wmblocks/card-header-footer', 'wmblocks/badge'];
...
const columnIcon = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("svg", {
  viewBox: "0 0 24 24",
  fill: "none",
