...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icons */ "./src/feature-columns/icons.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/feature-columns/editor.scss");
...
function Edit({
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: 'wmblocks-feat-cols-wrapper'
  });
  function updateCol(id, patch) {
    setAttributes({
      columns: columns.map(c => c.id === id ? {
        ...c,
        ...patch
      } : c)
    });
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
          className: "wmblocks-feat-chip wmblocks-feat-chip--main",
          children: "Feature Columns"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("span", {
          className: "wmblocks-feat-chip",
          children: [cols, " cols \xB7 ", columns.length, " items"]
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        className: `row row-cols-1 row-cols-md-${cols} g-4`,
        children: columns.map((col, idx) => {
          const isOpen = expandedId === col.id;
          const bgHex = _icons__WEBPACK_IMPORTED_MODULE_4__.ICON_BG_HEX[col.iconBg] || '#0d6efd';
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "col",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
              className: "wmblocks-feat-col-card",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
                className: `wmblocks-feat-icon-wrap d-inline-flex align-items-center justify-content-center fs-2 mb-3 p-2 rounded-3 ${col.iconBg}`,
                ...
                tagName: "a",
                className: `icon-link ${col.ctaVariant}`,
                value: col.ctaLabel,
                onChange: v => updateCol(col.id, {
                  ctaLabel: v
                }),
                allowedFormats: [],
                placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('CTA label…', 'wmblocks')
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                    ...
                    children: _icons__WEBPACK_IMPORTED_MODULE_4__.ICON_BG_OPTIONS.map(opt => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("button", {
                      className: 'wmblocks-feat-swatch' + (col.iconBg === opt.value ? ' is-active' : ''),
                      style: {
                        background: _icons__WEBPACK_IMPORTED_MODULE_4__.ICON_BG_HEX[opt.value]
                      },
                      onClick: () => updateCol(col.id, {
                        iconBg: opt.value
                      }),
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                    className: "wmblocks-feat-panel-label",
                    children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('CTA URL', 'wmblocks')
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("input", {
                    type: "url",
                    className: "wmblocks-feat-url-input",
                    value: col.ctaUrl,
                    placeholder: "https://",
                    onChange: e => updateCol(col.id, {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                    className: "wmblocks-feat-panel-label",
                    children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('CTA style', 'wmblocks')
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
                    className: "wmblocks-feat-pill-row",
                    children: CTA_VARIANTS.map(v => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("button", {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/feature-columns/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/feature-columns/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/feature-columns/block.json");
...
/***/ "./src/feature-columns/editor.scss"
/*!*****************************************!*\
  !*** ./src/feature-columns/editor.scss ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/feature-columns/style.scss"
/*!****************************************!*\
  !*** ./src/feature-columns/style.scss ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/feature-columns/block.json"
/*!****************************************!*\
  !*** ./src/feature-columns/block.json ***!
  \****************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wmblocks/feature-columns","version":"0.1.0","title":"Feature Columns","category":"watermelon-blocks","icon":"grid-view","description":"Bootstrap features — columns with icons layout. Responsive 3-column grid where each column has a Bootstrap Icon in a coloured rounded square, a heading, body text and an optional CTA link.","example":{},"supports":{"html":false,"anchor":true},"attributes":{"columns":{"type":"array","default":[{"id":"c1","icon":"lightning-charge-fill","iconBg":"text-bg-primary","title":"Featured title","body":"Paragraph of text beneath the heading to explain the heading. We\'ll add onto it with another sentence and probably just keep going until we run out of words.","ctaLabel":"Call to action","ctaUrl":"#","ctaVariant":"link-primary"},{"id":"c2","icon":"people-fill","iconBg":"text-bg-primary","title":"Featured title","body":"Paragraph of text beneath the heading to explain the heading. We\'ll add onto it with another sentence and probably just keep going until we run out of words.","ctaLabel":"Call to action","ctaUrl":"#","ctaVariant":"link-primary"},{"id":"c3","icon":"gear-fill","iconBg":"text-bg-primary","title":"Featured title","body":"Paragraph of text beneath the heading to explain the heading. We\'ll add onto it with another sentence and probably just keep going until we run out of words.","ctaLabel":"Call to action","ctaUrl":"#","ctaVariant":"link-primary"}]},"cols":{"type":"string","default":"3"},"iconSize":{"type":"string","default":"fs-2"}},"textdomain":"wm","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
...
/******/ 		var installedChunks = {
/******/ 			"feature-columns/index": 0,
/******/ 			"feature-columns/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["feature-columns/style-index"], () => (__webpack_require__("./src/feature-columns/index.js")))
