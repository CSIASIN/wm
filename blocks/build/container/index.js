...
function Edit({
  ...
  const combinedClassName = [blockProps.className, containerType, hasVideo ? 'position-relative' : '', hasVideo ? 'overflow-hidden' : '', padding, margin, backgroundColor, borderClasses, visibilityClasses, shadow].filter(Boolean).map(c => c.trim()).filter(Boolean).join(' ');
  const CONTAINER_TEMPLATE = [['core/paragraph', {
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Add your container content here... You can use this as holder block for all blocks", 'wm'),
    fontSize: 'small',
    style: {
      typography: {
        fontStyle: 'italic',
...
/* harmony import */ var _controls_controlanimate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../controls/controlanimate.js */ "./controls/controlanimate.js");
...
const containerIcon = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  save: () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks.Content, {})
});
