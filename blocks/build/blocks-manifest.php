...
return array(
	...
	'card-basic' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'wmblocks/card-basic',
		'version' => '0.1.0',
		'title' => 'Card Basic',
		'category' => 'watermelon-blocks',
		'icon' => 'index-card',
		'description' => 'A basic Bootstrap card wrapper.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
	...
	'card-body' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'wmblocks/card-body',
		'version' => '0.1.0',
		'title' => 'Card Body',
		'category' => 'watermelon-blocks',
		'icon' => 'editor-table',
		'description' => 'The inner structural content container for building cards or standalone sections.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
	...
	'card-image' => array(
		...
		'attributes' => array(
			...
			'imageDisplayClass' => array(
				'type' => 'string',
				'default' => 'img-fluid'
			),
			'imageAlignClass' => array(
				'type' => 'string',
				'default' => ''
			),
			...
			'imageBorderRadiusSize' => array(
				'type' => 'string',
				'default' => ''
			),
			'imageBorderOpacityClass' => array(
				'type' => 'string',
				'default' => ''
			),
			'imageBorderOpacityCustom' => array(
				'type' => 'string',
				'default' => ''
			),
			'imageBorderSides' => array(
				'type' => 'array',
				'default' => array(
					
				)
			),
			'imageBorderRemove' => array(
				'type' => 'array',
				'default' => array(
	...
	'card-wrapper' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'wmblocks/card-wrapper',
		'version' => '0.1.0',
		'title' => 'Card Wrapper',
		'category' => 'watermelon-blocks',
		'icon' => 'grid-view',
		'description' => 'A layout card container wrapper with adjustable width constraints.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
	...
	'heading' => array(
		...
		'category' => 'watermelon-blocks',
		'icon' => 'heading',
		'description' => 'Bootstrap heading — h1–h6 with custom container backgrounds, spacing, borders, display styles, and responsiveness.',
		'example' => array(
